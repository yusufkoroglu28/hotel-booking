...
const MyBookings = () => {
  ...
  const fetchUserBookings = async () => {
    try {
      const {data} = await axios.get('/api/booking/user', {headers: {Authorization: `Bearer ${await getToken}`}});
      if (data.success) {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title title='My Bookings' subTitle={'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laboriosam culpa, laborum odio tempore itaque quae delectus! Sunt excepturi officia ea.'} align='left'/>
